...
- Run: 2026-08-04T05:34:24.894Z to 2026-08-04T05:58:56.483Z
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| simulation-agent | 9/20 | 9/20 | 0 | 9 | 2 | 4/5 | 4 | 87969 | 79128 | 61 | — | 52 | 297716 |
...
- **simulation-agent / Occluded pedestrian emergence:** no-candidate — iteration_budget_exhausted: No candidate passed schema, map binding, full simulation, and requested semantic checks within 4 iterations.; bind_current_map: action child-enters-ego-path lane offset must be within -1..1
- **simulation-agent / Motorcycle and cyclist interaction:** no-candidate — iteration_budget_exhausted: No candidate passed schema, map binding, full simulation, and requested semantic checks within 4 iterations.; bind_current_map: choreography.interactions.3.actor: nearMiss routes are only supported for pedestrians
...
- **simulation-agent / Child occluded by two parked vehicles:** no-candidate — iteration_budget_exhausted: No candidate passed schema, map binding, full simulation, and requested semantic checks within 4 iterations.; bind_current_map: near_miss_trigger_unresolved at choreography.interactions.child-near-ego.trigger: near-miss trigger cannot be resolved against the canonical target trajectory
- **simulation-agent / Synchronized conflict-point near miss:** no-candidate — iteration_budget_exhausted: No candidate passed schema, map binding, full simulation, and requested semantic checks within 4 iterations.; bind_current_map: near_miss_trigger_unresolved at choreography.interactions.pedestrian-near-miss.trigger: near-miss trigger cannot be resolved against the canonical target trajectory
...
- **simulation-agent / Contradictory physical constraints:** expected-rejection — Provider returned no candidate for an unsupported request
