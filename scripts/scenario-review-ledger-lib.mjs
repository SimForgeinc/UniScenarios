...
export const SCENARIO_REVIEW_PROVENANCE_FILES = [
  ...
  'apps/studio/src/editor/actorRenderer.ts',
  'apps/studio/src/editor/controller.ts',
  'apps/studio/src/editor/document.ts',
  'apps/studio/src/editor/laneIndex.ts',
  'apps/studio/src/playback/controller.ts',
  'apps/studio/src/playback/model.ts',
  'apps/studio/src/playback/usePlayback.ts',
  'apps/studio/src/mapOverlays.ts',
  'apps/studio/src/maps.ts',
