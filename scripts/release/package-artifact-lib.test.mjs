...
test('accepts wildcard exports when at least one packaged artifact matches', async () => {
  ...
  assert.deepEqual(verified, [{ name: '@uniscenarios/openscenario', version: '1.0.0', targets: 2 }]);
});
