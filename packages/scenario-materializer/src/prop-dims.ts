...
const ACTOR_CLASSES_BY_CATALOG_ID: Readonly<Record<string, readonly string[]>> = {
  ...
  'vehicle.honda_civic': ['car'],
  'vehicle.toyota_camry': ['car'],
  'vehicle.tesla_model_3': ['car'],
  'vehicle.ford_mustang': ['car'],
  'vehicle.chevrolet_corvette': ['car'],
  'vehicle.porsche_911': ['car'],
  'vehicle.jeep_wrangler': ['car'],
  'vehicle.taxi': ['car'],
  'vehicle.police_cruiser': ['car'],
  'vehicle.police_suv': ['car'],
  'vehicle.fire_command_suv': ['car'],
  'vehicle.van': ['van'],
  'vehicle.ambulance': ['van', 'truck'],
  'vehicle.minivan': ['van'],
  'vehicle.delivery_van': ['van'],
  'vehicle.box_truck': ['truck'],
  'vehicle.semi_truck': ['truck'],
  'vehicle.fire_engine': ['truck'],
  'vehicle.dump_truck': ['truck'],
  'vehicle.garbage_truck': ['truck'],
  'vehicle.tow_truck': ['truck'],
  'vehicle.cement_mixer': ['truck'],
  'vehicle.utility_bucket_truck': ['truck'],
  'vehicle.tanker_truck': ['truck'],
  'vehicle.flatbed_truck': ['truck'],
  'vehicle.bus': ['bus'],
