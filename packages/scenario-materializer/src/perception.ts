...
import type { Environment, ActorSensor, MapDivergence, NumberOrExpr } from '@uniscenarios/scenario-model';
import { sensorAperture } from '@uniscenarios/scenario-model';
import type { PerceptionConfig, SimSensor } from '@uniscenarios/sim-engine';
