...
header.innerHTML = `<h1>@scenario-studio/prop-catalog</h1><p>${CATALOG.length} procedurally generated props · dimensions in metres · 1 m ground grid · origin at ground centre, +X towards the camera-right</p>`;
