...
const server = createServer(createScenarioCopilotHandler({ directProvider: generateDirectDraft, upstreamProvider: generateUpstreamChat2Scenic, simulationAgentProvider: generateSimulationAgent }));
