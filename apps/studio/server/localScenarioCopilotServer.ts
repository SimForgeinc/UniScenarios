...
import { generateVerifiedTemplateSearch } from './copilot/verifiedTemplateSearchProvider.js';
import { generateRelativeGoalOptimizer } from './copilot/relativeGoalOptimizerProvider.js';
...
const server = createServer(createScenarioCopilotHandler({ directProvider: generateDirectDraft, upstreamProvider: generateUpstreamChat2Scenic, simulationAgentProvider: generateSimulationAgent, simulationAgentVisionProvider: generateSimulationAgentVision, verifiedTemplateSearchProvider: generateVerifiedTemplateSearch, relativeGoalOptimizerProvider: generateRelativeGoalOptimizer }));
