 ...
 *
 *   1. `scen evaluate`'s reject filters accepted it (`verdict === 'accept'`,
...
const manifest = { kind: 'campaign-manifest', version: 1, campaign: 'occluded-pedestrian', generatedFrom: 'scen batch --all-maps --draws 8', templates: {}, cells: [] };
const ledger = {
