...
|---|---|---|---|---|
| Built-in procedural surface pack | `packages/city-renderer/src/surface-materials.ts` | Apache-2.0 | N/A (source code) | In-house shader code; no image, texture, model, or third-party payload. |
