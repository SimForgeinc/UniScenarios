...
const sourceOffer = 'https://github.com/eclipse-sumo/sumo/tree/v1_27_1 plus experiments/sumo-wasm/patches/sumo-1.27.1-emscripten.patch and experiments/sumo-wasm/build.sh';
